...
- [X] This is a responsive website with animations and contact info, designed to display your professional projects in an engaging way.
...
- [X] Framework grid system implementation(containers, rows, columns) OR Flexbox implementation
